...
export const EntryForm: React.FC<EntryFormProps> = ({ onAddEntry, onCancel }) => {
      ...
      <div className="bg-white rounded-3xl p-6 shadow-xl border border-slate-100 space-y-4">
        ...
        {image && (
          <div className="relative group">
            <img src={image} alt="Upload" className="w-full h-64 object-cover rounded-2xl" />
            <button 
              type="button"
        ...
        <div className="flex items-center justify-between pt-4 border-t border-slate-100">
          ...
          <div className="flex gap-3">
            ...
            <button
              type="submit"
              className="px-8 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-full font-semibold shadow-lg shadow-indigo-200 transition-all"
            >
              Save Entry
            </button>
          </div>
